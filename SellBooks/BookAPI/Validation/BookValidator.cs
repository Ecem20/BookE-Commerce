...
namespace BookAPI.Validation
{
    public class BookValidator : AbstractValidator<ProductDto>
    {
        ...
        public BookValidator(ApplicationDbContext db)
        {
            ...
            RuleFor(book => book.ProductStockQuantity).InclusiveBetween(0, 100).WithMessage("Stok miktarı 1 ile 100 arasında olmalıdır");
        ...
        public bool BeUniqueISBN(string isbnNumber, int bookId)
        {
