...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.File($"C:/Users/10132587/source/repos/SellBooks-Son/Logs/ShoppingCartAPI.txt",
        ...
        .WriteTo.File($"C:/Users/10132587/source/repos/SellBooks-Son/ErrorLog/ShoppingCartAPI.txt",
            outputTemplate: "ShoppingCartAPI | {Timestamp:yyyy-MM-dd HH:mm:ss.fff zzz} [{Level:u3}] {Message:lj}{NewLine}{Exception}",
            rollingInterval: RollingInterval.Day,
...
//Log.Logger = new LoggerConfiguration()
//    .MinimumLevel.Error()
//    .WriteTo.File($"C:/Users/10132587/source/repos/SellBooks-Son/ErrorLog/ShoppingCartAPI.txt", outputTemplate: "ShoppingCartAPI | {Timestamp:yyyy-MM-dd HH:mm:ss.fff zzz} [{Level:u3}] {Message:lj}{NewLine}{Exception}",
