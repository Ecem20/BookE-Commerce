...
namespace MVCWeb.Controllers
{
    public class AuthController : Controller
    {
        ...
        private IValidator<RegistrationRequestDto> _validator;


        public AuthController(IAutService autService,ITokenProvider tokenProvider, IEmailService emailService, IValidator<RegistrationRequestDto> validator)
        {
        ...
        public async Task<IActionResult> Register(RegistrationRequestDto obj)
        {
            ...
            ValidationResult validationResult = await _validator.ValidateAsync(obj);
